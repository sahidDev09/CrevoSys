...
const StartupCard = () => {
  return (
    <div className=" m-2 md:m-0 md: pb-10">
      <h1 className=" md:text-6xl md:pb-5 text-2xl text-white text-center my-5">
        ...
        <div className="relative h-[550px] w-full rounded-2xl container mx-auto bg-gradient-to-b from-[#F6AA68] to-[#90643D] overflow-hidden">
          ...
          <div className=" absolute w-full p-10">
            ...
            <div className="flex justify-between items-center">
              ...
              <div>
                <button className="md:p-3 p-2 bg-white rounded-full md:text-xl font-semibold uppercase text-black">
                  JOin with team
                </button>
              </div>
            </div>
